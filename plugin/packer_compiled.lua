...
_G.packer_plugins = {
  ...
  ["nvim-vtsls"] = {
    loaded = true,
    path = "/home/marco/.local/share/nvim/site/pack/packer/start/nvim-vtsls",
  ...
  undotree = {
    loaded = true,
    path = "/home/marco/.local/share/nvim/site/pack/packer/start/undotree",
  ...
  ["vim-jsx-typescript"] = {
    loaded = true,
    path = "/home/marco/.local/share/nvim/site/pack/packer/start/vim-jsx-typescript",
